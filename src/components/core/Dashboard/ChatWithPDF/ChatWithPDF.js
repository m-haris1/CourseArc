function ChatWithPdfPage() {
    return (
      <div className="min-h-screen bg-richblack-200 font-inter px-4 py-12">
        <div className="max-w-maxContent mx-auto bg-richblack-100 rounded-xl shadow-lg p-8 border border-richblue-600">
          {/* Welcome Heading */}
          ...
          {/* Instructions */}
          <ol className="list-decimal list-inside text-black text-base space-y-2 mb-6">
